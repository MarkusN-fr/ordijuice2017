#' Perfom PCA (Principal Component Analysis) on JUICE data.
#'
#' \code{draw.pca} performs PCA (Principal Component Analysis) on the
...
#'  listed here, so that \code{draw.pca} can use it.
